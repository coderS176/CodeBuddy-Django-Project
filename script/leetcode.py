...
def get_problems_solved(driver, username):
    ...
    for i in div:
        ...
        if match:
            ...
            problems_leetcode.append({ 'problem_title':  i['data-title'], 'problem_link': problem_link, 'submission_link': submission_link, 'submission_id':submission_id, 'platform': 'Leetcode', 'username': username })
        else:
            break
